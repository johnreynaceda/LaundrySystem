<x-user-layout>
    <div class="flex flex-col justify-center flex-1 md:px-12 lg:flex-none">
        <div class="relative ">
            <div class="relative">
                <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="relative sm:overflow-hidden">
                        <div class="relative 2xl:px-4 px-0 2xl:py-20 py-10 sm:px-6 lg:px-8">
                            <div class=" p-10 mx-auto  flex flex-col justify-center items-center ">
                                <div class="relative">
                                    <svg class="absolute animate-pulse 2xl:-left-16 -left-8 text-main 2xl:-top-10 -top-5 2xl:h-10 h-8"
            ...
            <div class="-bottom-[23rem] w-full absolute left-0 ">
                <center>
                    <img src="{{ asset('images/bg.png') }}" class="h-[45rem]" alt="">
                </center>
            </div>
        </div>
    </div>
